  ...
  return (
    modal.isOpen ? (
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl flex items-center justify-center">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none h-full mt-10">
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t mx-5 md:mx-0">
                ...
                <div className="relative p-6 flex flex-col md:flex-row">
                  <div className='bg-gray-200 rounded-lg flex justify-center items-center mx-5 md:mx-0'>
                    <Image className='w-1/2 md:w-screen p-4' priority height={800} width={800} src={modal.item?.picture || '/pokemon_logo1.png'} alt={modal.item?.name || 'Pokemon'} />
                  </div>
                  <div className='mx-5 my-5 md:my-0'>
                    <p className='text-black'>{modal.item?.description}</p>
                    <div className='bg-cyan-500 my-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2  gap-x-6 gap-y-6 rounded-lg p-6'>
                      <div>
